  ...
  return (
    <div className="w-[100%] h-[84vh] flex flex-col my-6 bg-neutral-900 text-[14px] text-white rounded-md">
      <div className="w-[100%] flex flex-col gap-4 p-4">
        ...
        <a
  href="https://drive.google.com/file/d/1C8pertni7jKo994aZcltIeOGgljcYW_G/view?usp=sharing" // Replace with the URL you want to redirect to
  className="flex items-center px-4 py-2 gap-2 hover:shadow-md text-white border hover:border-0 rounded-md"
  target="_blank" rel="noopener noreferrer" // Open link in a new tab/window and improve security
>
  <HiOutlineArrowTrendingUp size={24} /> {/* Icon for Resume */}
  Resume
</a>
      ...
      <div className="w-[100%] flex flex-col text-white gap-4 p-4">
        <h2 className="text-white text-[16px] font-bold border-b border-neutral-500 pb-2">
          Socials
        </h2>
        <NavLink
